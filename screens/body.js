      ...
      <SafeAreaView className="p-5 pb-24">
        ...
        <ScrollView
          ...
          <View>
            ...
            <Text className="text-center text-2xl font-normal text-black">Enter the size</Text>
          ...
          <View className="flex flex-row justify-evenly my-3">
            <TouchableOpacity
              className="bg-[#2dd4dc] py-2 px-5 rounded-2xl"
              activeOpacity={0.8}
              onPress={() => {
                if (
          ...
          <View className="my-5 w-full min-h-[100px] bg-slate-300 rounded-lg p-3">
            {error && (
          ...
          <View className="bg-[#2dd4dc] flex items-center py-1 mt-12 rounded-2xl" >
            <Text className="text-base font-medium text-black-80">Created and Developed By</Text>
            <Text className="text-sm font-normal text-gray-50">Sourav Bhowal & Preety Kumari</Text>
        </View>
        </ScrollView>
      </SafeAreaView>
    </LinearGradient>
